...
function PaymentEndComponent() {
  ...
  const { stepOneData, stepFourData } = location.state || {};

  return (
    <div className="justify-center w-full h-auto pb-20 bg-secondary-celeste md:pd-10">
      <div className="py-10">
        <IconPayEndComponent />
      </div>
      ...
      <div className="flex flex-col items-center justify-center p-4 mx-auto my-8 border-white shadow-md border-1 rounded-3xl w-72 md:w-[40em] lg:w-[60em]">
        ...
        <p className="text-base font-light text-center text-white">
          {stepOneData && `para el Grupo ${stepOneData.groupName}`}
        </p>
