  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-lg p-5 bg-white shadow-lg w-80 md:w-96 lg:w-full font-primary rounded-3xl">
        ...
        <h2 className="text-2xl font-bold text-center text-secondary-blue md:text-3xl lg:text-4xl">
          {title}
        </h2>
        <p className="text-lg text-center text-primary-celeste md:text-xl lg:text-2xl custom-message-style">
          {message}
        </p>
        {buttons.length > 0 && (
